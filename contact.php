...
<div id="map-container" class="z-depth-1" style="height:355px;width: 55%;margin-left: 45%;margin-bottom: -32%;"></div>
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Email &nbsp;&nbsp;&nbsp;&nbsp;: </h6><p style="margin-top: -30px;margin-left: 75px;">themmhostelinfo@gmail.com</p>
    <h6 class="card-subtitle mb-2 text-muted">Contact : </h6><p style="margin-top: -30px;margin-left: 70px;">+91-80-555555 / +91-80-565656</p>
    <h6 class="card-subtitle mb-2 text-muted">Website : </h6><p style="margin-top: -30px;margin-left: 75px;">www.themmcollege.com </p>
